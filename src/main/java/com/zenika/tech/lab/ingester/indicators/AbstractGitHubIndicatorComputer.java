...
public abstract class AbstractGitHubIndicatorComputer<T extends HasGithubIndicatorId, V extends PageableHistory> extends AbstractGitHubEndpointRouteBuilder implements IndicatorComputer, GitHubBased {
