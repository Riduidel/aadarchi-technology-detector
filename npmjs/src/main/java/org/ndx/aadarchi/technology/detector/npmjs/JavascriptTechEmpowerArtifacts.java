...
import org.ndx.aadarchi.technology.detector.npmjs.exception.CannotReadPackage;
...
public class JavascriptTechEmpowerArtifacts extends TechEmpowerArtifactLoader<NpmjsContext> {
	...
	protected Collection<ArtifactDetails> toArtifactDetails(File packageJson) {
		try {
			...
			throw new CannotReadPackage(String.format("Can't read package.json file %s", packageJson), e);
		}
	}
}
