...
def main(api_key):
    ...
    #requests_cache.install_cache('stackoverflow_cache', expire_after=3600) --> segflaut so far...
...
#     requests_cache.install_cache('cache_stackoverflow', expire_after=600000)
#     technology_tags = get_technology_tags(api_key)
#     if technology_tags is not None:
#         with open('technologies.json', 'w') as fp:
#             json.dump(technology_tags, fp, indent=4)
